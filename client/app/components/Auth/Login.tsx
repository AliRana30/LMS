...
const Login: FC<Props> = ({ setRoute, setOpen, route }) => {
  ...
  return (
    <div className={`w-full rounded-lg shadow-xl p-6 sm:p-8 relative font-poppins ${theme === 'dark' ? 'bg-slate-900 text-white' : 'bg-white text-gray-900'
      }`}>
      ...
      <form onSubmit={formik.handleSubmit}>
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className={`w-full px-4 py-2 rounded-lg border focus:outline-none focus:ring-2 focus:ring-[#37a39a] ${theme === 'dark'
        ...
        <div className="mb-6">
          ...
          <div className="relative">
            ...
            <button
              ...
              className={`absolute right-3 top-1/2 -translate-y-1/2 ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'
                }`}
            >
      ...
      <div className="flex gap-4">
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-2 py-2 rounded-lg border transition-colors ${theme === 'dark'
